 ...
 */
class OpenSettings(private val context: Context) : Tool {
    ...
    override fun execute(args: Map<String, Any?>): ToolResult {
        ...
        val action = PANEL_ACTIONS[panel] ?: PANEL_ALIASES[panel]?.let { PANEL_ACTIONS[it] }
    ...
    private companion object {
        val PANEL_ACTIONS: Map<String, String> = mapOf(
        ...
        val PANEL_ALIASES: Map<String, String> = mapOf(
